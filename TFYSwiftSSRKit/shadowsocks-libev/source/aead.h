...
int aead_encrypt_tcp(cipher_ctx_t *, size_t, uint8_t *, size_t, uint8_t *, size_t, uint8_t *, uint8_t *);
int aead_decrypt_tcp(cipher_ctx_t *, size_t, uint8_t *, size_t, uint8_t *, size_t, uint8_t *, uint8_t *);
